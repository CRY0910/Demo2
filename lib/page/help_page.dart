      ...
      body: ListView(
        ...
        children: <Widget>[
         ...
         Container(
          height: 60,
             child:ListTile(
            title: Text('Why does the converted amount assets\nChange?'),
            onTap: () {
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => HelpDetailPage(title: "Why does the converted amount\nassets Change?",content: "The equivalent calculation in the asset is tha"
          ...
          Container(
              height: 60,
              child:ListTile(
                title: Text('Where is the captital flow after transaction purchase?'),
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => HelpDetailPage(title: "Where is the captital flow after\ntransaction purchase?",content: "After the purchase order is completed,the fund\n"
          ...
          Container(
              height: 60,
              child:ListTile(
                title: Text('Why limmit the mumber of changes\ntonicknames'),
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => HelpDetailPage(title: "Why limmit the mumber of changes\ntonicknames",content: "For the safety of your transactions,the current\n"
